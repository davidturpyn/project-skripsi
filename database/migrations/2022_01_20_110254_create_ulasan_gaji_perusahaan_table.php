...
class CreateUlasanGajiPerusahaanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ulasan_gaji_perusahaan', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ulasan_gaji_perusahaan');
    }
}
